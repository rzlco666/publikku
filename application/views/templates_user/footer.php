    ...
    <a href="https://api.whatsapp.com/send?phone=08817819040&text=Saya%20mau%20bertanya%20tentang" class="float" target="_blank">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    Developed with <i class="mdi mdi-heart text-danger"></i> by Fikri Haikal
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- apexcharts -->
        <script src="<?=base_url('assets_user/'); ?>libs/apexcharts/apexcharts.min.js"></script>

        <script src="<?=base_url('assets_user/'); ?>libs/jquery-knob/jquery.knob.min.js"></script> 

        <!-- Jq vector map -->
        <script src="<?=base_url('assets_user/'); ?>libs/jqvmap/jquery.vmap.min.js"></script>
        <script src="<?=base_url('assets_user/'); ?>libs/jqvmap/maps/jquery.vmap.usa.js"></script>

        <script src="<?=base_url('assets_user/'); ?>js/pages/dashboard.init.js"></script>
