                    ...
                    <div class="col-xl-5 col-sm-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="p-2">
                                    <h5 class="mb-5 text-center">Silahkan Daftar untuk melanjutkan.</h5>
                                    <?php 
                                    ...
                                    ?>
                                    <form method="post" class="form-horizontal" action="<?php echo base_url('Auth/proses_daftar'); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <a href="<?=base_url('Auth/login'); ?>" class="text-muted"><i class="mdi mdi-account-circle mr-1"></i> Sudah punya akun? login sekarang</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
